...
class CButtonColumn extends CGridColumn
{
     ...
     * please refer to the {@link http://www.php.net/manual/en/language.expressions.php php manual}.
     */
//	public $deleteButtonUrl='Yii::app()->controller->createUrl("delete",array("id"=>is_array($data->primaryKey)?$data->primaryKey[key($data->primaryKey)]:$data->primaryKey))';
    public $deleteButtonUrl='Yii::app()->controller->createUrl("delete",array("id"=>is_array($data->primaryKey)?$data->primaryKey["id"]:$data->primaryKey))';
    /**
