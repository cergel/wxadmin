...
return array(
    'db' => array(
        'class' => 'CDbConnection',
        'connectionString' => 'mysql:host=10.66.120.110;dbname=db_wxmovieadmin',
        'emulatePrepare' => true,
        'username' => 'db_wxmovieadmin',
        'password' => 'db_wxmovieadmin',
        'charset' => 'utf8',
        'tablePrefix'=>'t_'
    ),
    'db_luck' => array(
    ...
    'db_gold_seat' => array(
        'class'=>'CDbConnection',
        'connectionString' => 'mysql:host=10.66.148.43;port=15001;dbname=gold_seat',
        'emulatePrepare' => true,
        'username' => 'data_user',
        'password' => 'A1b2c3d4',
        'charset' => 'utf8',
    ...
    'db_goods_center' => array(
        'class'=>'CDbConnection',
        'connectionString' => 'mysql:host=10.104.88.192:15003;dbname=goods;',
        'emulatePrepare' => true,
        'username' => 'bigdata',
        'password' => 'oPYQ7lkGDKA0X2tD7Hdf3yJzU',
        'charset' => 'utf8',
    ),
    'db_active'=>array(
        'class'=>'CDbConnection',
        'connectionString' => 'mysql:host=10.66.120.110;dbname=db_activeuser',
        'emulatePrepare' => true,
        'username' => 'db_activeuser',
        'password' => 'sTthRDmHbPplnZu_JD2wuiHSs',
        'charset' => 'utf8',
    ),
    'db_pee' => array(
        'class' => 'CDbConnection',
        'connectionString' => 'mysql:host=10.66.120.110;dbname=pee',
        'emulatePrepare' => true,
        'username' => 'pee',
        'password' => 'jqBkQK1GzWsRyPooCuiVo40cN',
        'charset' => 'utf8',
        'tablePrefix'=>'t_'
    ),
    'db_opensystem' => array(
    ...
    'db_message' => array(
        'class' => 'CDbConnection',
        'connectionString' => 'mysql:host=10.66.120.110:3306;dbname=db_message_center',
        'emulatePrepare' => true,
        'username' => 'db_message',
        'password' => 'pojIixOGVDTGv8E_0D5EPsXPK',
        'charset' => 'utf8',
        'tablePrefix'=>'t_'
    ),
);
