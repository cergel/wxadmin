 ...
 * @property integer iChannelID
 */
class CinemaNotificationChannel extends CActiveRecord
{
	/**
	...
	{
		return '{{cinema_notification_channel}}';
	}
	...
	public function rules()
	{
		...
		return array(
			array('iNotificationID, iChannelID', 'required'),
			array('iNotificationID, iChannelID', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('iNotificationID, iChannelID', 'safe', 'on'=>'search'),
		);
	}
