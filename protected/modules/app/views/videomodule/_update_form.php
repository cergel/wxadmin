	...
	<?php echo $form->errorSummary($model,'<div class="alert alert-danger">','</div>'); ?>
		...
		<div class="form-group">
		 ...
		 <div class="col-sm-9">
			...
			//选取平台的交集和差集填充默认选中的值
			echo CHtml::checkBoxList('VideoModule[Platform]',$intersect,$Platform_list,array('labelOptions'=>array('class'=>'checkbox-inline col-xs-1'),'template'=>"{beginLabel} {input} {labelTitle}  {endLabel}",'separator'=>'&nbsp;')); ?>
          </div>
		</div>
		...
		<!--影片一详细列表-->
		<div class="form-group MdouleDetailBox" id="MovieInfo1">
		...
		<div class="form-group" >
		  ...
		  <button class="btn btn-success search_moive" target="MovieInfo2">
            ...
            查询电影
				...
				<!--影片二详细列表-->
		<div class="form-group MdouleDetailBox" id="MovieInfo2">
			<div class="col-sm-9 col-sm-offset-3">				
				<div class="col-xs-10 panel panel-warning">
				  <div class="panel-body">
						<div class="col-xs-6">
							...
							<?php if($model->Video2_Pic):?>
							<div class="form-group" >
							<?php echo Chtml::label('图片预览','' ,array('class'=>'col-sm-3 control-label no-padding-right')); ?>
								<div class="col-sm-9">
								<img class="col-sm-9" src = "<?php echo $path."/{$model->Video2_Pic}"?>" />
								</div>
							</div>
							<?php endif?>	
							 <div class="form-group">
