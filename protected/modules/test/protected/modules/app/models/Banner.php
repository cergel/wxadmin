...
class Banner extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('iStatus, iSort, iAndroid, iIOS, iCreated, iUpdated', 'numerical', 'integerOnly'=>true),
            ...
            //array('sLink', 'url'),
			array('sDescription,sShareContent, sSharePic,sPicture', 'safe'),
			...
			array('iBannerID, sTitle, sDescription,sShareContent, sSharePic, sPicture, sLink, iShowAt, iHideAt, iStatus, iSort, iCreated, iUpdated', 'safe', 'on'=>'search'),
		);
	}
