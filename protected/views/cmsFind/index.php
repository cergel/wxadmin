...
<div class="page-header">
    <h1>管理发现</h1>
    <a class="btn btn-success" href="/cmsFind/create?type=<?php echo !empty($_GET['type'])?$_GET['type']:'' ?>">新增</a>
</div>
 ...
 <?php $this->widget('application.components.WxGridView', array(
            ...
            'columns'=>array(
                ...
                array(
                    'name' => 'channel',
                    'filter' => '',
                    'value'=>'ActiveFind::model()->getChannelStr($data->channel)',
                    'htmlOptions' => array(
                        'width' => 100,
                    ),
                ),
                array(
                    ...
                    'buttons'=>array(
                        'update' => array(
                            'label'=>'编辑',
                            'url'=>'"/cmsFind/update/".$data->id."?type=".$data->f_type',
                        ),
                    )
                ),
            ),
