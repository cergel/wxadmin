...
?>
<form name="Statistics" action="/index.php/statisticsVoice/index" method="get">
    <div class="search_box" width="100%" style="margin-top:20px">
        ...
        <div style="margin-top:20px"><span style="color: #ff0a0a;margin-left: 50px;">填写日期格式为20161226,时间间隔不能超过31天</span></divmargin-top:20px>
    </div>
    <div width="100%" style="margin-top: 40px">
        <table class="result_table" style="margin:0 auto;font-weight: normal;color:#3ca0d9;font-size: 16px;border:solid 1px #3ca0d9" width="360px" border="1">
            <tr>
                <td align="center">时间</td>
                <td align="center">回复总量</td>
